...
;;   (interactive)
;;   (let ((point (point)))
;;     (insert (propertize (+doom-dashboard--center +doom-dashboard--width "")
...
;;   (insert "\n")
;;   (insert (+doom-dashboard--center +doom-dashboard--width "Welcome, Ari"))
;;   (insert "\n")
;;   (insert "\n")
;;   (insert "\n")
;;   (insert "\n"))
...
(defun +dashboard-widget-banner ()
  (+dashboard-insert-image-banner fancy-splash-image))
  ...
  (when (file-exists-p banner)
    (let* ((title "abcdf")
      ...
      (when title
        ...
        (insert (format "%s\n\n" (propertize title 'face 'doom-dashboard-banner)))))))

;; override the resize fn for now
